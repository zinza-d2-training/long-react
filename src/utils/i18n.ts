...
const translationEn = {
  ...
  'Cập nhật nhanh, chính xác nhất': 'Fastest and most accurate',
  ...
  'Địa chỉ': 'Address',
  'Kết luận': 'Conclude',
  'Đã được tiêm phòng bệnh Covid-19': 'Have been vaccinated against Covid-19',
  'Chưa được tiêm phòng bệnh Covid-19': 'Not vaccinated against Covid-19',
  'Mũi số': 'Nose',
  'Thời gian tiêm': 'Injection time',
  'Tên vaccine': 'Name of the vaccine',
  ...
  'Đăng ký chưa thành công': 'Registration failed',
